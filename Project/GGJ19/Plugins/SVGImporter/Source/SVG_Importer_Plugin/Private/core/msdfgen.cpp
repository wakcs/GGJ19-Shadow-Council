...
#endif
    {
        ...
        for (int y = 0; y < h; ++y) {
            ...
            for (int x = 0; x < w; ++x) {
                ...
                double negDist = -SignedDistance::Infinity.distance;
                double posDist = SignedDistance::Infinity.distance;
                int winding = 0;
                ...
                double sd = SignedDistance::Infinity.distance;
...
#endif
    {
        ...
        for (int y = 0; y < h; ++y) {
            ...
            for (int x = 0; x < w; ++x) {
                ...
                double psd = SignedDistance::Infinity.distance;
                if (posDist >= 0 && fabs(posDist) <= fabs(negDist)) {
                    psd = posDist;
                    winding = 1;
                    for (int i = 0; i < contourCount; ++i)
...
#endif
    {
        ...
        for (int y = 0; y < h; ++y) {
            ...
            for (int x = 0; x < w; ++x) {
                ...
                double d = fabs(SignedDistance::Infinity.distance);
                double negDist = -SignedDistance::Infinity.distance;
                double posDist = SignedDistance::Infinity.distance;
                int winding = 0;
                ...
                MultiDistance msd;
                msd.r = msd.g = msd.b = msd.med = SignedDistance::Infinity.distance;
                if (posDist >= 0 && fabs(posDist) <= fabs(negDist)) {
                    msd.med = SignedDistance::Infinity.distance;
                    winding = 1;
                    for (int i = 0; i < contourCount; ++i)
